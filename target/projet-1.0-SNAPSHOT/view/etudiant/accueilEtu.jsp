                    ...
                    <ul>
                        <c:forEach var="seance" items="${seances.value}">
                            <li class="single-event"
                                ...
                                <c:if
                                        test="${(requestScope.today.getTime()-seance.dateFin.getTime())/(24*60*60*1000)<=30}">
                                    <a
                                            href="/role/justificatifEtu?id=${seance.id}" >
                                        <em
